...
nohup python -u src/all_models/DualGCN_crossencoder_v4.py --config_path ${config_path} --out_dir ${out_dir}\
    --mode train --losstype ${losstype} --random_seed ${random_seed} --gpu_num ${gpu_num} >${out_dir}/dual_crossencoder_v4_savedata.log 2>${out_dir}/dual_crossencoder_v4_savedata.progress &
